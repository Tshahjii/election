  ...
  return (
    <Stack sx={{ gap: 2 }}>
      <Stack direction={{ xs: 'column', sm: 'row' }} sx={{ justifyContent: 'space-between', alignItems: { xs: 'stretch', sm: 'center' }, gap: 2 }}>
        ...
        <Button variant="outlined" color="inherit" startIcon={<ArrowBackOutlined />} onClick={() => navigate('/admin/users/access-management')}>
          Back
        </Button>
      </Stack>

      <Box component="form" onSubmit={(event) => { event.preventDefault(); navigate('/admin/users/access-management'); }}>
        <MainCard
          title="User Details"
        ...
        >
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} sx={{ justifyContent: 'flex-end', gap: 1.5, mt: 3 }}>
            <Button type="button" variant="outlined" color="inherit" onClick={() => navigate('/admin/users/access-management')}>
              Cancel
            </Button>
            <Button
              type="submit"
