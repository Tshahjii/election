...
const translations = {
  en: {
    ...
    'menu.authSettings': 'Auth Settings',
    'menu.districtConfig': 'District Configuration',
    'authSettings.title': 'Authentication Settings',
    'authSettings.subtitle': 'Manage login flow, password requirements, and default OTP bypass modes.',
    'authSettings.defaultOtpTitle': 'Default OTP Mode (Bypass SMS)',
    'authSettings.defaultOtpDesc': 'When enabled, the system will use "123456" as the OTP for all logins. SMS delivery is bypassed.',
    'authSettings.passwordVerifyTitle': 'Password Verification',
    'authSettings.passwordVerifyDesc': 'When enabled, users must provide their account password to request an OTP. When disabled, OTP can be requested using only the registered mobile number.',
    'authSettings.saveSuccess': 'Authentication settings updated successfully.',
    'authSettings.saveError': 'Failed to update authentication settings.',
    'auth.defaultOtpAlert': 'OTP Bypass active: default OTP is',
    ...
    'field.gender': 'Gender',
    'field.genderPlaceholder': 'Select Gender',
    'field.designationPlaceholder': 'Select Designation',
    ...
    'election.yes': 'Yes',
    'election.no': 'No',
    'election.tabAssignments': '1. Team Assignments & Duty Execution',
    'election.tabAttendance': '2. Team-Wise Attendance List',
    'election.tabReports': '3. Official Appointment Orders',
    'election.attendanceSheetTitle': 'Team-Wise Attendance List',
    'election.attendanceSheetDesc': 'High-density paper saving layout to print 5-6 teams data per page.',
    'election.searchTeamOrBooth': 'Search team number or booth...',
    'election.orderNo': 'Order No',
    'election.selectTeam': 'Select Team',
    'election.allTeams': 'All Teams',
    'election.teamNo': 'Team No',
    'election.printOrderPdf': 'Print Order / PDF',
    'election.scheduleControlsTitle': 'Training & Departure Schedule Details',
    'election.saveToDb': 'Save to Database',
    'election.savingToDb': 'Saving...',
    'election.addTrainingRow': '+ Add Training / Departure',
    'election.purposeLabel': 'Purpose',
    'election.dateLabel': 'Date',
    'election.dbSaveSuccess': 'District training schedule saved to database successfully!',
    'election.dbSaveError': 'Error saving training schedule to database.',
    ...
    'election.restoreExemptBtn': 'Remove Exemption',
    'election.restoreExemptSuccess': 'Employee removed from exemption list successfully.',
    'election.restoreExemptFailed': 'Failed to remove employee from exemption list.',
    'election.searchExemptLogPlaceholder': 'Search by employee code, name, post or reason...',
    'election.statusExempted': 'Exempted',
    'election.statusAvailable': 'Available for Duty',
    'election.assignRandomDuties': 'Assign Random Duties',
    'election.vacantCount': 'Vacant Count',
    'election.dutyCount': 'Number of Duties to Assign'
  },
  hi: {
    ...
    'menu.nagarPanchayat': 'शहरी निर्वाचन',
    'menu.nagariNikay': 'ग्रामीण निर्वाचन',
    ...
    'menu.helpComplaints': 'सहायता एवं शिकायतें',
    ...
    'field.genderPlaceholder': 'लिंग चुनें',
    'field.designationPlaceholder': 'पदनाम चुनें',
    ...
    'election.yes': 'हाँ',
    'election.no': 'नहीं',
    'election.tabAssignments': '1. टीम असाइनमेंट एवं ड्यूटी निष्पादन',
    'election.tabAttendance': '2. टीम उपस्थिति पत्रक',
    'election.tabReports': '3. नियुक्ति आदेश रिपोर्ट',
    'election.attendanceSheetTitle': 'टीम अनुसार उपस्थिति पत्रक',
    'election.attendanceSheetDesc': 'एक पेज पर 5-6 टीमों का डेटा प्रिंट करने हेतु हाई-डेंसिटी लेआउट।',
    'election.searchTeamOrBooth': 'टीम नंबर या बूथ खोजें...',
    'election.orderNo': 'आदेश क्रमांक',
    'election.selectTeam': 'दल चुनें',
    'election.allTeams': 'सभी दल',
    'election.teamNo': 'दल क्रमांक',
    'election.printOrderPdf': 'आदेश प्रिंट / PDF',
    'election.scheduleControlsTitle': 'प्रशिक्षण एवं प्रस्थान सारणी विवरण',
    'election.saveToDb': 'डेटाबेस में सेव करें',
    'election.savingToDb': 'सेव हो रहा है...',
    'election.addTrainingRow': '+ नया प्रशिक्षण/प्रस्थान जोड़ें',
    'election.purposeLabel': 'प्रयोजन',
    'election.dateLabel': 'तारीख (Date)',
    'election.dbSaveSuccess': 'प्रशिक्षण सारणी सफलतापूर्वक डेटाबेस में सहेजी गई!',
    'election.dbSaveError': 'डेटाबेस में सहेजने में त्रुटि हुई।',
    ...
    'election.restoreExemptBtn': 'छूट से हटाएं',
    'election.restoreExemptSuccess': 'कर्मचारी को छूट सूची से सफलतापूर्वक हटा दिया गया।',
    'election.restoreExemptFailed': 'कर्मचारी को छूट सूची से हटाने में विफल।',
    'election.searchExemptLogPlaceholder': 'कर्मचारी कोड, नाम, पद या कारण से खोजें...',
    'election.statusExempted': 'छूट प्राप्त (Exempted)',
    'election.statusAvailable': 'ड्यूटी के लिए उपलब्ध (Available)',
    'election.assignRandomDuties': 'रैंडम ड्यूटी आवंटित करें',
    'election.vacantCount': 'रिक्त पदों की संख्या',
    'election.dutyCount': 'आवंटित करने हेतु ड्यूटी संख्या'
  }
};
