...
class UserSeeder extends Seeder
{
    ...
    private function ensureMasterData(int $actorId): array
    {
        ...
        $empTypeId = (int) DB::table('master_emp_types')->where('emp_type', 'Permanent')->value('id');
        ...
        $departmentId = (int) DB::table('master_departments')->where('department', 'Election Office')->value('id');
        ...
        $designationId = (int) DB::table('master_designations')->where('designation', 'District Admin')->value('id');

        DB::table('master_pay_levels')->updateOrInsert(
            ['level' => 'Level 8'],
            [
                'amount_pay' => '47600 - 151100',
                'grade_pay' => '4800',
                'status' => 1,
                'created_by' => $actorId,
                'updated_by' => $actorId,
        ...
        $payLevelId = (int) DB::table('master_pay_levels')->where('level', 'Level 8')->value('id');

        DB::table('master_cities')->updateOrInsert(
            ['state_id' => $stateId, 'district_id' => $raipurDistrictId, 'city_name' => 'Raipur'],
            [
                'city_type' => 'urban',
                'status' => 1,
                'created_by' => $actorId,
        ...
        $raipurCityId = (int) DB::table('master_cities')
            ->where('state_id', $stateId)
            ->where('district_id', $raipurDistrictId)
            ->where('city_name', 'Raipur')
            ->value('id');
        ...
        DB::table('master_employees')->updateOrInsert(
            ...
            [
                ...
                'ofc_id' => (int) DB::table('master_offices')->where('office_code', 'DEO-RP')->value('ofc_id'),
